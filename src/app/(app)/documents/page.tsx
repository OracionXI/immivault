...
type DisplayDocument = ConvexDocument & { clientName: string; uploadedDisplay: string };
    ...
    return (
        <div className="space-y-6">
            <PageHeader
                ...
                onAction={() => {
                    // File upload via Convex Storage is implemented in Phase 3
                    alert("File upload coming in Phase 3");
                }}
            />
            <DataTable
